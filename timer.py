...
hh_button_plus_0.grid(column=2, row=1)
hh_button_minus_0.grid(column=2, row=4)
...
hh_button_plus_1.grid(column=3, row=1)
hh_button_minus_1.grid(column=3, row=4)
...
mm_button_plus_0.grid(column=4, row=1)
mm_button_minus_0.grid(column=4, row=4)
...
mm_button_plus_1.grid(column=5, row=1)
mm_button_minus_1.grid(column=5, row=4)
...
ss_button_plus_0.grid(column=6, row=1)
ss_button_minus_0.grid(column=6, row=4)
...
ss_button_plus_1.grid(column=7, row=1)
ss_button_minus_1.grid(column=7, row=4)
